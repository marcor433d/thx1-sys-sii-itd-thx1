...
function NoticeCardStudent({ title, inf }) {
  return (
    <div className="flex flex-col w-full h-64 bg-gradient-linear text-white border border-slate-300 justify-center p-4 gap-4 rounded-lg shadow-xl transform transition duration-500 hover:scale-110 opacity-90 hover:opacity-100">
