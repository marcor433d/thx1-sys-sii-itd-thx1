  ...
  return (
    <section className="mb-8 w-8/10 m-auto">
      ...
      <div className="h-40vh grid grid-cols-3 gap-8">
        ...
        <div className="bg-itd-blue transform transition duration-500 scale-100 hover:scale-105 opacity-9 hover:opacity-100 rounded-lg items-center justify-center flex hover:bg-transparent">
          <img
