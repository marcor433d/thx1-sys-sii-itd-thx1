...
const ExtraCurricularSection = () => {
  return (
    <section className="w-8/10 m-auto mt-16">
      ...
      <div className="h-35vh grid grid-cols-3 bg-gradient-linear-blue text-white rounded-lg shadow-2xl p-6 transform transition duration-500 scale-100 hover:scale-105 opacity-90 hover:opacity-100 items-center justify-center">
