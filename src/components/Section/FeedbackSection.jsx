  ...
  return (
    <div className="w-8/10 grid items-center m-auto">
      <section className="h-40vh">
        ...
        <div className="bg-gradient-linear-white rounded-lg shadow-2xl h-9/10 grid grid-cols-3 p-4 items-center justify-center border border-gray-300 transform transition duration-500 scale-100 hover:scale-105 opacity-80 hover:opacity-100">
