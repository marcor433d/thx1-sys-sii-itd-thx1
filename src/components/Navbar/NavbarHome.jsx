...
const NavbarHome = () => {
  ...
  return (
    <nav className="container-nav--main items-center bg-transparent with-navbar">
      <a
        href="/"
      ...
      <div className="center-total text-gray-400 font-extralight text-xl gap-5">
        ...
        <div className="relative group inline-block">
          <button
            ...
            className="hover:text-white hover:font-normal hover:scale-105  container-more--a gap-1 transform transition duration-500"
          >
            MAS
            <svg
